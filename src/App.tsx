  ...
  return (
    <Layout>
        <Routes>
            ...
            <Route path={ `${Paths.componentEdit}/:id` } element={ <EditComponent /> } />
            <Route path={ `${Paths.component}/:id` } element={ <Component /> } />

            <Route path={ Paths.complectAdd } element={ <AddComplect /> } />
            <Route path={ `${Paths.complectEdit}/:id` } element={ <EditComplect /> } />
            <Route path={ `${Paths.complect}/:id` } element={ <Complect /> } />
            
            <Route path={ Paths.buyOperationAdd } element={ <AddBuyOperation /> } />
            <Route path={ `${Paths.buyOperationEdit}/:id` } element={ <EditBuyOperation /> } />
            <Route path={ `${Paths.buyOperation}/:id` } element={ <BuyOperation /> } />
            
            <Route path={ Paths.packedOperationAdd } element={ <AddPackedOperation /> } />
            <Route path={ `${Paths.packedOperationEdit}/:id` } element={ <EditPackedOperation /> } />
            <Route path={ `${Paths.packedOperation}/:id` } element={ <PackedOperation /> } />
